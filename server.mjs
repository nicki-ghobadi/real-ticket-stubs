...
const TICKET_EXTRACT_SYSTEM = [
  ...
  "  • comma form: \"Sec FLR2, Row 4, Seat 15 - 16\" (expand to one entry per seat in seating[]),",
  ...
  "  eventLine2 (artist/event title — NOT the page header \"You Got the Tickets\"),",
  ...
  "  seating (OPTIONAL array when the screenshot shows MULTIPLE tickets or seats —",
  "    one object per ticket with its own section/row/seat, e.g.",
  "    [{\"section\":\"117\",\"row\":\"14\",\"seat\":\"1\"},{\"section\":\"117\",\"row\":\"14\",\"seat\":\"2\"}].",
  "    Use when you see multiple ticket cards, a seat range (Seats 1-4), or a list.",
  "    Leave [] or omit when only one seat is shown.),",
  "  price (\"180.00\" — no $),",
